...
import com.rtls.trackmate.entity.DestinationPoint;
import com.rtls.trackmate.entity.GeofencePoint;
import com.rtls.trackmate.entity.Notification;
import com.rtls.trackmate.service.GeofenceTrasitionService;
...
public class CreateGeofenceActivity extends AppCompatActivity
        implements
    ...
    public static final String EXTRA_MESSAGE_ID = "com.rtls.trackmate.SENDID";
    public static final String EXTRA_MESSAGE_UID = "com.rtls.trackmate.SENDUID";
    private static final String NOTIFICATION_MSG = "com.rtls.notifiction";
...
//                    if (markers.size() >= 3) {
//
//                        if(pointInPolygon(destinationMarker.getPosition(), polygon)){
//
...
////                                            isSent = true;
////
////                                            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(CreateGeofenceActivity.this);
...
////
////                                                            Intent intent = new Intent(CreateGeofenceActivity.this, TrackingActivity.class);
...
////
////                                        } else if (!isSent) {
////                                            Alerter.create(CreateGeofenceActivity.this).setTitle(getResources().getString(R.string.alert_title_geofence)).setText(getResources().getString(R.string.alert_msg_geofence)).setBackgroundColorRes(R.color.colorAccent).show();
////                                        }
////                                    }
//
////                                    @Override
...
//
//                            } catch (Exception e) {
//                                Alerter.create(CreateGeofenceActivity.this).setTitle(getResources().getString(R.string.alert_title_failed_set_object)).setText(getResources().getString(R.string.alert_msg_failed_set_object)).setBackgroundColorRes(R.color.colorAccent).show();
//                            }
//                        } else {
//                            Alerter.create(CreateGeofenceActivity.this).setTitle(getResources().getString(R.string.alert_title_outside_geofence)).setText(getResources().getString(R.string.alert_msg_outside_geofence)).setBackgroundColorRes(R.color.colorAccent).show();
//                        }
//                    }
                }
            }
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.hasChild(id)) {
                    ...
                    Alerter.create(CreateGeofenceActivity.this).setText(getResources().getString(R.string.alert_title_synchronize_geofence)).setBackgroundColorRes(R.color.colorAccent).show();
                    geofenceActivated = true;//activate geofence

                } else {
                    Alerter.create(CreateGeofenceActivity.this).setTitle(getResources().getString(R.string.alert_title_failed_find_id)).setText(getResources().getString(R.string.alert_msg_failed_find_id)).setBackgroundColorRes(R.color.colorAccent).show();
    ...
    public void showCustomDialog(String title, String msg) {
        final Dialog dialog = new Dialog(CreateGeofenceActivity.this);
    ...
    private Geofence createGeofence(LatLng latLng) {
        ...
        return new Geofence.Builder()
                ...
                .setCircularRegion(latLng.latitude, latLng.longitude, CreateGeofenceActivity.GEOFENCE_RADIUS)
