...
import com.rtls.trackmate.entity.ContactMessage;
...
public class ContactUsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name = intent.getStringExtra(AboutActivity.EXTRA_MESSAGE_NAME);
        email = intent.getStringExtra(AboutActivity.EXTRA_MESSAGE_EMAIL);
