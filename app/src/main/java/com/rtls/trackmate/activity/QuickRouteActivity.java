...
public class QuickRouteActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*targetId = intentKu.getStringExtra(CreateGeofenceActivity.EXTRA_MESSAGE_ID);
        String userUID = intentKu.getStringExtra(CreateGeofenceActivity.EXTRA_MESSAGE_UID);*/
