...
public class BroadcastActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public static final String EXTRA_MESSAGE_SHORT_ID = "com.rtls.trackmate.SENDSHORTID";
    // Google Map
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //@Yefta, I changed the intents below to get it from the CreateGeofenceActivity.java
        ...
        //Tambahan James untuk ambil tracking session key dari CreateGeofenceActivity.java
            ...
            public void onLocationChanged(Location location) {
                ...
                if (diffTime > 5000 && isBroadcast) {
                    ...
                    if (isGeofenceDrawed) {
                         ...
                         *//*   //*Crossing the Border Notification ---- James punya 26 Nov 2020
...
//                            Alerter.create(BroadcastActivity.this).setTitle("You selected no!").setText("Emergency status set to false").setBackgroundColorRes(R.color.colorAccent).show();
    ...
    private void notifyAlert(String msg) {
        ...
        notificationBuilder.setAutoCancel(true)
                ...
                .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.jadylogo_254))
                .setTicker("Hearty365")
                .setContentTitle("TrackMate Alert")
                .setContentText(msg)
